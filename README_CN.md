...
<p align="center">
  ...
  <a href="https://github.com/spock-wen/codeProxy">🖥️ 管理面板</a> ·
  <a href="https://github.com/spock-wen/CliRelay/issues">🐛 报告问题</a> ·
  <a href="https://github.com/spock-wen/CliRelay/pulls">✨ 功能请求</a>
</p>
...
Docker Compose 是 CliRelay 推荐的安装方式。仓库内的 `docker-compose.yml` 默认使用已发布的 `registry.cn-hangzhou.aliyuncs.com/hihope_clirelay/clirelay:latest` 镜像，并同时启动 API 服务和 updater sidecar。
