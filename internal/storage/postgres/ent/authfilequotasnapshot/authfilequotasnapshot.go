...
const (
	// Label holds the string label denoting the authfilequotasnapshot type in the database.
	Label = "auth_file_quota_snapshot"
	...
	// Table holds the table name of the authfilequotasnapshot in the database.
	Table = "auth_file_quota_snapshots"
)

// Columns holds all SQL columns for authfilequotasnapshot fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldDateKey,
...
// OrderOption defines the ordering options for the AuthFileQuotaSnapshot queries.
